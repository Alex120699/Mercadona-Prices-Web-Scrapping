...
option = st.sidebar.radio("Selecciona una opción:", ["Home", "Ver productos", "Detalles de producto", "Histórico de Precios", "KPIs", "IVA Dashboards"])
...
if option == "Home":
    ...
    details.show()
elif option == "Histórico de Precios":
    historico.show()
elif option == "KPIs":
    kpis.show()
